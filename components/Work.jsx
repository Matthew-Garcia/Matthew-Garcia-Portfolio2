...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      Welcome to my portfolio! Here you’ll find projects in robotics, embedded systems, IT, and digital design - real-world solutions built with hands-on engineering.</motion.p>
